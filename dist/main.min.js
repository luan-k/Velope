...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _throttle_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./throttle.js */ \"./scripts/modules/throttle.js\");\n\n\nwindow.onload = function WindowLoad(event) {\n  var new_scroll_position = 0;\n  var last_scroll_position;\n  var headerClass = document.querySelectorAll(\"header.header\");\n  headerClass[0].setAttribute(\"id\", \"header\");\n  var header = document.getElementById(\"header\");\n\n  // if there is an adminbar add padding to the header\n\n  var adminbar = document.getElementById(\"wpadminbar\");\n  var adminbarHeight = jquery__WEBPACK_IMPORTED_MODULE_0___default()(\"#wpadminbar\").height();\n  if (!adminbar) {\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#header').css(\"padding-top\", \"0px\");\n  } else {\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#header').css(\"padding-top\", adminbarHeight + \"px\");\n  }\n  var scroll = function scroll(e) {\n    last_scroll_position = window.scrollY;\n    if (new_scroll_position < last_scroll_position && last_scroll_position > 140) {\n      header.classList.remove(\"slideDown\");\n      header.classList.add(\"slideUp\");\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()(\"#header\").css(\"position\", \"fixed\");\n      if (new_scroll_position < last_scroll_position && last_scroll_position > 300) {\n        header.classList.remove(\"slideUp\");\n        header.classList.add(\"slideDown\");\n      }\n    } else if (last_scroll_position <= 200) {\n      header.classList.remove(\"slideUp\");\n      header.classList.remove(\"slideDown\");\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()(\"#header\").css(\"position\", \"absolute\");\n    }\n    if (screen.width < 600) {\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()(\"#header\").css(\"position\", \"relative\");\n    }\n    /* else if ( new_scroll_position > last_scroll_position ) {\n      header.classList.remove( \"slideUp\" );\n      header.classList.add( \"slideDown\" );\n      console.log(\"ha\");\n      if (last_scroll_position <= 100){\n        header.classList.remove( \"slideUp\" );\n        header.classList.remove( \"slideDown\" );\n        $( \"#header\" ).css( \"position\", \"absolute\" );\n      }\n    }  */\n\n    new_scroll_position = last_scroll_position;\n  };\n  window.addEventListener('scroll', (0,_throttle_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(scroll, 300));\n  var lastNavBarHeight = 100;\n  checkSize(); // init\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).resize(checkSize);\n\n  // adding top padding on body equal to the header height\n  function checkSize() {\n    var navHeight = jquery__WEBPACK_IMPORTED_MODULE_0___default()(\"#header\").height();\n    if (navHeight !== lastNavBarHeight) {\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()(\"main\").css(\"padding-top\", navHeight + \"px\");\n      lastNavBarHeight = navHeight;\n    }\n  }\n};\n\n//# sourceURL=webpack://cursos-pec-motors/./scripts/modules/scrool-up-display-menu.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nvar throttle = function throttle(fn, delay) {\n  var lastTime = 0;\n  return function () {\n    var now = new Date().getTime();\n    if (now - lastTime < delay) return;\n    lastTime = now;\n    fn.apply(void 0, arguments);\n  };\n};\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (throttle);\n\n//# sourceURL=webpack://cursos-pec-motors/./scripts/modules/throttle.js?");
